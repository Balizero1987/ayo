# KBLI Metals, Electronics & Machinery Manufacturing (24xxx-28xxx)
...
#### KBLI 2410 - Manufacture of Basic Iron & Steel
...
**Costs**: IDR 500M-2B setup (excluding smelter equipment IDR 500B-5T)
...
**Costs**: IDR 80M-200M (setup + certifications)
...
#### KBLI 2592 - Metal Treatment & Coating
...
**Costs**: IDR 100M-300M (includes wastewater treatment plant)
...
**Description**: Manufacture of semiconductors, printed circuit boards, electronic components
...
- SDPPI certificate (Ministry of Communication) for telecom equipment
  ...
  - Cost: IDR 5M-20M per product
  - Processing: 2-4 months
- TKDN certification (local content 25-40%)

**Timeline**: 12-18 months

**Costs**: IDR 80M-250M (setup + SDPPI certifications)
...
**Costs**: IDR 150M-800M (setup + environmental compliance)
...
**Costs**: IDR 80M-250M (setup + certifications)
...
**Costs**: IDR 120M-400M (setup + safety certifications)
...
- **Cost**: IDR 2M-5M per foreign worker
...
- Cost: IDR 50M-300M setup + IDR 10M-50M/month disposal
...
### Mistake 8: Hiring Foreign Workers Without RPTKA
