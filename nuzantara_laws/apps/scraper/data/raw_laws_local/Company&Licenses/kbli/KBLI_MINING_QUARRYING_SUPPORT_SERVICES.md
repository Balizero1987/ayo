# KBLI Mining, Quarrying & Support Services (07xxx-09xxx)
...
- **Costs**: IDR 5B-20B (setup + exploration)
...
- **Costs**: IDR 10B-100B+ (large-scale operations)
...
- **Timeline**: 24-48 months (exploration → production)
- **Costs**:
...
- **Costs**: IDR 100B-500B+ (extremely capital-intensive)
- **Special Notes**:
...
#### **KBLI 08101 - Quarrying and Cutting of Ornamental and Building Stone**
...
- **Timeline**: 12-18 months
- **Costs**: IDR 5B-20B (setup + equipment)
- **Special Notes**:
...
- **Licenses**: IUPK, AMDAL, NIB
- **Timeline**: 36-60 months
- **Costs**: IDR 100B-500B+ (underground mining)
- **Royalty**: 5%-7%
- **Special Notes**:
...
- **Costs**: IDR 500M-5B+ per campaign
...
**B. Trial Mining and Drilling Services**
...
- **Costs**: IDR 50K-500K per meter drilled (depends on depth, geology, location)
- **Special Notes**:
...
- **Costs**: IDR 50K-500K per sample analyzed (depends on method, elements)
...
- **Costs**: IDR 10M-100M per month (depends on pumping rate)
...
- **Costs**: IDR 5B-50B+ (depends on mine size)
...
### **3. Export Bans = Smelter Requirement**
...
### **10. Currency Risk (IDR Volatility)**
